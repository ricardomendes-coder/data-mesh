...
CATALOG: dict[str, dict[str, str]] = {
    "pt": {
        ...
        # ── charts that did not import, marking the gap they left ──
        "Chart not imported": "Gráfico não importado",
        "a column it reads no longer exists": "uma coluna que ele lê não existe mais",
        "a table it reads no longer exists": "uma tabela que ele lê não existe mais",
        "too many series to draw": "séries demais para desenhar",
        "it is split two ways at once": "ele é quebrado por duas dimensões ao mesmo tempo",
        "no measure could be recognised": "nenhuma medida foi reconhecida",
        "several measures on one time series": "várias medidas numa mesma série temporal",
        "its measure cannot be split into series": "a medida dele não pode virar séries",
        "this chart type has no equivalent yet": "este tipo de gráfico ainda não tem equivalente",
        "its query no longer runs": "a consulta dele não roda mais",
        "it could not be translated": "não foi possível traduzi-lo",
